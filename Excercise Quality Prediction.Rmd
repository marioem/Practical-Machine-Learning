...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oob3
resultsdf[modelNo,3] <- testoob3
resultsdf[modelNo,4] <- score3
```
...
set.seed(728665723)
modelFit6 <- train(ptrTraining$classe ~ .,method="rf",preProcess="pca",
                   trControl = ctrl, data=ptrTraining)
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oob6
resultsdf[modelNo,3] <- testoob6
resultsdf[modelNo,4] <- score6
```
...
ctrl <- trainControl(method = "cv", allowParallel = T)
set.seed(728665723)
modelFit11 <- train(ptrTraining$classe ~ ., method="rf", trControl = ctrl,
                    data=ptrTraining)
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oob11
resultsdf[modelNo,3] <- testoob11
resultsdf[modelNo,4] <- score11
```
...
set.seed(728665723)
modelFit13 <- train(ptrTraining$classe ~ ., method="rf", 
                    trControl = ctrl, data=ptrTraining)
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oob13
resultsdf[modelNo,3] <- testoob13
resultsdf[modelNo,4] <- score13
```
...
ctrl <- trainControl(method = "cv", allowParallel = T)
set.seed(728665723)
modelFit7 <- train(ptrTraining$classe ~ ., method="gbm",preProcess="pca",
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oob7
resultsdf[modelNo,3] <- testoob7
resultsdf[modelNo,4] <- score7
```
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oobRF
resultsdf[modelNo,3] <- testoobRF
resultsdf[modelNo,4] <- scoreRF
```
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oobRF2
resultsdf[modelNo,3] <- testoobRF2
resultsdf[modelNo,4] <- scoreRF2
```
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oobRF3
resultsdf[modelNo,3] <- testoobRF3
resultsdf[modelNo,4] <- scoreRF3
```
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oobRF4
resultsdf[modelNo,3] <- testoobRF4
resultsdf[modelNo,4] <- scoreRF4
```
...
```{r, echo=FALSE}
resultsdf[modelNo,1] <- modelNo
resultsdf[modelNo,2] <- oobRF5
resultsdf[modelNo,3] <- testoobRF5
resultsdf[modelNo,4] <- scoreRF5
```
